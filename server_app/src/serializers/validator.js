      ...
      for (i; i < fields.length; i++) {
        if ((field = fields[i].toLowerCase())) {
          ...
          if ((deep && field === "required") || field === "default") {
            if (
              field === "required" &&
              typeof details["default"] === "undefined" &&
              !data
            ) {
          ...
          if (Validator.plugins[field]) {
            ...
            Object.prototype.toString.call(this.schema[key][field]) ==
              "[object Object]" &&
            Validator.plugins._objects.indexOf(field) == -1
          ) {
            if (
              loop.call(
                this,
                Object.keys(this.schema[key][field]),
                this.schema[key][field],
                field,
                this.retrieved[key][field],
                key + "." + field
              )
            ) {
              return this.errors;
        ...
        if (options.value.min > options.against) {
          options.error(
            ...
            "Must be greater than " +
              options.value.min +
              (options.data.type === "string" ? " characters long." : "")
          );
        }
      }
