...
export const IMPORT_FILE_MESSAGES = {
    ...
    FAILED:'Error Uploading file(s)',
    DELETE_ITEMS:'Deleting old items',
    UPLOADING_FILE:'Uploading file(s) to the server',
...
export const GRAPHICS_PAGE_FR = {
    ...
    IMPORT_DATA_TITLE: "Insérer votre canevas (Préventifs,Correctifs,Données fixes équipements,visites réglementaires) ",
    IMPORT_DATA_TITLE1: "Insérer votre caneva",
...
export const SUCCESS_MESSAGES = {
    LOGIN: "Votre session a été expirée! veuillez vous connecter à nouveau",
    INSCRIPTION_1: "Votre compte a été crée!",
    ACTIVATION_MSG: "Merci de contacter votre admin pour activer votre compte.",
}
