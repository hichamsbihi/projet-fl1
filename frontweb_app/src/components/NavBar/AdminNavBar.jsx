...
import {UserOutlined,FileSyncOutlined,ContactsOutlined,LogoutOutlined,UploadOutlined} from "@ant-design/icons"

export default class AdminNavBar extends React.Component {

   
    render() {
        const path_maping = ["root","/home","/profile","/data-import/equipements/static","/data-import/stock","/data-import/correctifs","/data-import/preventifs"];
                    ...
                    <div className="row-sustain">
                        ...
                        <div className="col-lg-12">
                            <div className="main-menu">
                                <ul id="mobilemenu">
                                    <li>
                                        <Link className={selected_menu_item[0]==1 ? "sustain-nave-selected" : ""} to={path_maping[1]}>Acceuil</Link>
                                    </li>
                                    <li>
                                        <Link className={selected_menu_item[0]==3 ? "sustain-nave-selected" : ""} to={path_maping[3]}>Données fixes 'Equipements'</Link>
                                    </li>
                                    <li>
                                        <Link className={selected_menu_item[0]==4 ? "sustain-nave-selected" :""} to={path_maping[4]}>Données du stock</Link>
                                    </li>
                                    <li>
                                        <Link className={selected_menu_item[0]==5 ? "sustain-nave-selected" :""} to={path_maping[5]}>Correctifs</Link>
                                    </li>
                                    <li>
                                        <Link className={selected_menu_item[0]==6 ? "sustain-nave-selected" :""} to={path_maping[6]}>Préventifs</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            <div className="menu-btn">
                                <a href="/login" onClick={() => sessionStorage.clear()} style={{fontSize: 20}}>Logout</a>
                                </div>
